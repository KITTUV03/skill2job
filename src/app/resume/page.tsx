    ...
    <div className="flex min-h-[calc(100vh-4rem)]">
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 space-y-8 max-w-7xl mx-auto">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Upload your resume to extract skills, certifications, experience, and calculate job match scores.</p>
        </div>
        <ResumeUploader />
      </main>
    </div>
